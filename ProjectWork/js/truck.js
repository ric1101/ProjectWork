...
function stampaTruck(piatti) {
  ...
  piatti.forEach((element) => {
    ...
    } else if (portata === "BIANCHE" && bianche < 1) {
      containerPiatti.innerHTML += `<h2 class="mt-4">BIANCHE</h2>
        <div class="row bianche">
         
        </div>`;
      bianche++;

    } else if (portata === "ROSSE" && rosse < 1) {
      containerPiatti.innerHTML += `<h2 class="mt-4">ROSSE</h2>
        <div class="row rosse">
